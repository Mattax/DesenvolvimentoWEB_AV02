...
<html>
    ...
    <body >
        ...
        <%
            ...
            out.print("<tr><th>EDITAR</th><th>ID PRODUTO</th><th>NOME</th><th>MARCA</th><th>FORNECEDOR</th><th>SETOR</th><th>PERECÍVEL</th></tr>"); 
             while(resultSet.next()){            
                    out.print("<tr>");                
                           out.print("<td><a href='cadastrar.jsp?"+
                                   "ra="+resultSet.getString("ra")+
                                   "&nome="+resultSet.getString("nome")+
                                   "&marca="+resultSet.getString("marca")+
                                   "&fornecedor="+resultSet.getString("fornecedor")+
                                   "&setor="+resultSet.getString("setor")+
                                   "&perecivel="+resultSet.getString("perecivel")+
                                   "'>Editar</a> </td>");                
